...
public class SocijalniMrezhi {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < Q; i++) {
            ...
            if (query[0].equals("PATH")) {
                System.out.println(graph.shortestPath(query[1], query[2]));
            } else if (query[0].equals("REACHABLE")) {
                System.out.print("Users reachable from " + query[1] + " in " + query[2] + " steps: ");
                graph.pathsOfLengthN(query[1], Integer.parseInt(query[2]));
            } else if (query[0].equals("PRINT")) {
